...
class AuthController extends GetxController {
  ...
  Future<StudentsAuth> studentLogin() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        await prefs.setString(
          'student_level',
          studentdata.studentLevel.toString(),
        );
        await prefs.setString(
          'student_role',
          studentdata.studentRole.toString(),
        );
        ...
        controllerStudentPsw.clear();
        controllerStudentReg.clear();
        Get.back();
  ...
  Future<void> loadData() async {
    ...
    if (regno != null ||
      ...
      if (student_reg.value.isNotEmpty) {
        ...
        await Get.offAll(() => MyBottomNavigation());
        // }
      }
  ...
  Future<void> logout() async {
    ...
    prefs.remove('student_reg');
    prefs.remove('student_course_id');
    prefs.remove('student_program_id');
    prefs.remove('student_year');
    prefs.remove('student_level');
    prefs.remove('student_role');
    Get.off(()=>LoginScreen());
  }
